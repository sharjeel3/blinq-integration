...
import { IntegrationProvider } from "./supportedProviders";
...
export const Provider: FC<Props> = ({ supportedProviders }) => {
  ...
  return (
    <>
      {supportedProviders.map((provider: IntegrationProvider) => {
        const isLinked =
          linkedSettings.linkedProviders.filter(
